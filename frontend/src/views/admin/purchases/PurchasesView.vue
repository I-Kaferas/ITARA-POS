    ...
    <div v-if="activeTab === 'orders'" class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-slate-200">
      ...
      <table class="min-w-full divide-y divide-slate-200 text-sm">
        ...
        <tbody class="divide-y divide-slate-100">
          ...
          <tr
            v-for="row in store.purchaseOrders"
            :key="row.id"
    ...
    <div v-else class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-slate-200">
      ...
      <table class="min-w-full divide-y divide-slate-200 text-sm">
        ...
        <tbody class="divide-y divide-slate-100">
          ...
          <tr v-for="row in store.purchaseInvoices" :key="row.id" class="hover:bg-slate-50">
      ...
      <p v-if="!store.purchaseInvoices.length" class="px-4 py-8 text-center text-slate-500">{{ t('org.empty') }}</p>
