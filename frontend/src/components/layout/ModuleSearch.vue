...
const modules = computed(() => [
  ...
  { to: '/admin/sales/returns', label: t('sales.tabs.returns'), group: t('nav.pos'), keywords: 'retours remboursement' },
  ...
  { to: '/admin/hospitality', label: t('nav.hospitality'), group: t('nav.section.main'), keywords: 'restaurant hotel tables cuisine chambres' },
  ...
  { to: '/admin/organization/branding', label: t('org.tabs.branding'), group: t('nav.organization'), keywords: 'logo image marque branding' },
  ...
  { to: '/admin/organization/terminals', label: t('org.tabs.terminals'), group: t('nav.organization'), keywords: 'terminaux pos' },
  { to: '/admin/organization/devices', label: t('org.tabs.devices'), group: t('nav.organization'), keywords: 'appareils devices' },
  ...
  { to: '/admin/organization/permissions', label: t('org.tabs.permissions'), group: t('nav.organization'), keywords: 'permissions droits' },
